...
if [[ -z $1 ]];
 then
  echo "Usage: $0 <!PERSON NICK!> <STAKE_ACCOUNT_ADDRESS>"
  exit 0
 else
   if [[ -z $2 ]];
    then
...
$APP_SOLANA deactivate-stake --stake-authority $KEY_TDS22 $STAKE_ACC

alert_telegram "$1: $STAKE_ACC deactivating starts!"
